...
@Composable
fun LegalAndPoliciesScreen(navController: NavHostController) {
    Column(
        Modifier
            .fillMaxSize()
        ...
        Row(
            ...
            Text(text = stringResource(id = R.string.leagal_and_policies_title), style = CLBTypography.h4)
            Icon(
...
@Preview
@Composable
fun LegalAndPoliciesScreenPreview() {
